...
if ( isset($_POST['register']) ) {
    ...
    if ( $confirmPassword != $userPassword ) {
        ...
        $check = mysqli_query($con, "SELECT * FROM users WHERE userEmail='$userEmail'");
        ...
        if ( mysqli_num_rows($check) >= 1 ) {
            ...
            $token = sha1($userFirstName);

            $insert_query = "INSERT INTO users (userEmail, userPassword, userFirstName, userLastName, userStreetAddress, userStreetAddress2, userCity, userState, userZip, userCountry, userPhone, userDateJoined, userToken) VALUES ('$userEmail', '$password', '$userFirstName', '$userLastName', '$userStreetAddress', '$userStreetAddress2', '$userCity', '$userState', '$userZip', '$userCountry', '$userPhone', NOW(), '$token')";
...
<!--                    <!-- Sign Up Button -->-->
<!--                    <li class="navbar-btn active"><a href="signup.php">Sign Up <span class="sr-only">(current)</span> </a></li>-->
<!--                    <!-- Login Button -->-->
<!--                    <li class="navbar-btn"><a href="login.php">Login</a></li>-->
                    ...
                    if ( !isset($_SESSION['userEmail']) ) {
                        echo "<!-- Sign Up Button -->
<li class='navbar-btn active'><a class='login-btn' href='signup.php'>Sign Up <span class='sr-only'>(current)</span></a></li>
<!-- Log In Button -->
            ...
            <form action="signup.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="userEmail" value="<?=((isset($userEmail))?$userEmail:'')?>" required maxlength="100" autofocus />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userFirstName" value="<?=((isset($userFirstName))?$userFirstName:'')?>" required maxlength="50" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userLastName" value="<?=((isset($userLastName))?$userLastName:'')?>" required maxlength="50" />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userStreetAddress" value="<?=((isset($userStreetAddress))?$userStreetAddress:'')?>" required maxlength="100" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userStreetAddress2" value="<?=((isset($userStreetAddress2))?$userStreetAddress2:'')?>" maxlength="100" />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>City:</label>
                            <input type="text" class="form-control" name="userCity" value="<?=((isset($userCity))?$userCity:'')?>" required maxlength="50" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <label>State:</label>
                            <select class="form-control" name="userState" value="<?=((isset($userState))?$userState:'')?>" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userZip" value="<?=((isset($userZip))?$userZip:'')?>" required maxlength="5" />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <label>Country:</label>
                            <select class="form-control" name="userCountry" value="<?=((isset($userCountry))?$userCountry:'')?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="userPhone" value="<?=((isset($userPhone))?$userPhone:'')?>" required maxlength="10" />
                        </div>
                    </div>
