...
<head>
    ...
    <!-- Custom CSS -->
    <link href="../../public/css/contactus.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="container mainContent">
        ...
        <div class="row">
            ...
            <!-- Photo on the right -->
            <div class="col-xs-12 col-lg-6">
                <img src="../../public/img/store/IMG_6651.JPG" alt="Bong on stairs" class="img-responsive">
                <br />
                <img src="../../public/img/store/IMG_6656.JPG" alt="Jars in a case" class="img-responsive">
            </div>
        </div>
    </div>
